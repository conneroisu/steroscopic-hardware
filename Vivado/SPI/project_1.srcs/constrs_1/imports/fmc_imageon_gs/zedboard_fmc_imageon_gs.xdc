...
# phjones: UNUSED -group [get_clocks hdmii_clk] # phjones: UNUSED -group [get_clocks CLKDIV_c_0] # phjones: UNUSED -group [get_clocks vita_clk_div4_l_n_0]
...
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD_ss_io[0]}]
set_property SLEW SLOW [get_ports PMOD_io0_io]
set_property IOSTANDARD LVCMOS25 [get_ports PMOD_io0_io]
set_property IOSTANDARD LVCMOS25 [get_ports PMOD_io1_io]
set_property IOSTANDARD LVCMOS25 [get_ports PMOD_sck_io]
